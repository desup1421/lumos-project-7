        ...
        <ul className="sidebar-list">
          ...
          <li>
            ...
            <ul className="sub-menu">
              ...
              <li><Link to="/inventory/add"><i className="bx bxs-plus-circle nav-icon"></i> Add product</Link></li>
          ...
          <li>
            ...
            <ul className="sub-menu">
              <li><i className="bx bxs-log-in-circle nav-icon"></i>Stock-in</li>
              <li><i className="bx bxs-log-out-circle nav-icon"></i>Stock-out</li>
            </ul>
          </li>
          <li>
            <div className="flex-gap">
